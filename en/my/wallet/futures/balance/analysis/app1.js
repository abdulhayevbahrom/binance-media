...
const pnl_seven = async () => {
  ...
  let body = {
    user: { user_id },
    start_date: moment(lastSevenDay).format("YYYY-MM-DD HH:mm:ss"),
    end_date: moment(today_start).format("YYYY-MM-DD HH:mm:ss"),
  };
...
const pnl_all = async () => {
  ...
  let body = {
    user: { user_id },
    start_date: moment(year_start).format("YYYY-MM-DD HH:mm:ss"),
    end_date: moment(today_start).format("YYYY-MM-DD HH:mm:ss"),
  };
