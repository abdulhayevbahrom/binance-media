...
//     ],
//     label: "Время",
//     defaultValue: "Последние 30 днейr",
//   },
//   {
//     id: "orderType3",
//     label: "Криптовалюта",
...
//   // Toggle list on click and apply rotation to icon
...
//     // Rotate icon if the list is open
...
//       // Update the default value dynamically
...
// // Function to update the displayed default value dynamically
...
//   // Hover qilinganda modalni ochish
//   tooltipButton.addEventListener("mouseover", function () {
//     modal.classList.add("active");
//   });

//   // // Tugmadan yoki modalning o'zidan chiqib ketilganda yopish
...
//   // btnOpenModal.addEventListener("click", function (event) {
//   //   event.stopPropagation(); // Click event boshqa joyga o‘tishining oldini oladi
//   //   mainModal.classList.toggle("active"); // Aktiv holatini o‘zgartirish
//   //   mainHistory.style.overflow = "hidden";
//   // });

//   // // Modal tashqarisiga bosilganda yopish
//   // document.addEventListener("click", function (event) {
//   //   if (!btnOpenModal.contains(event.target) && !mainModal.contains(event.target)) {
//   //     mainModal.classList.remove("active");
//   //     mainHistory.style.overflow = "visible";
//   //   }
//   // });
//   // Modal tashqarisiga bosilganda yopish
...
//     event.stopPropagation(); // Click event boshqa joyga o‘tishining oldini oladi
//     secondModal.classList.toggle("active"); // Aktiv holatini o‘zgartirish
//     // Skrollni butunlay o‘chirish
//     document.body.style.overflow = "hidden";
//   });
...
//   //  selectedValues.dateRange = "2025-03-17 - 2025-03-24";
//   let start_date = selectedValues.dateRange.split(" - ")[0];
//   let end_date = selectedValues.dateRange.split(" - ")[1];
//   let API = SERVER_URL + "/orader/transaction-history/crypto";
//   try {
...
//     console.log(">>", err);
//   }
//   console.log("start", selectedValues);
// }
